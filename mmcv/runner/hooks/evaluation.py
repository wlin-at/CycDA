...
class EvalHook(Hook):
    ...
    def _do_evaluate(self, runner):
        ...
        if hasattr(runner, 'DA_config'):
            results = self.test_fn(runner.model, self.dataloader, DA_config = runner.DA_config)
        else:
    ...
    def _save_ckpt(self, runner, key_score):
        ...
        if self.compare_func(key_score, best_score):
            ...
            best_ckpt_name = f'best_{self.key_indicator}_{current}_{runner.timestamp}.pth'
...
class DistEvalHook(EvalHook):
    ...
    def _do_evaluate(self, runner):    #   todo in the case of distributed training,  the evaluation func
        """perform evaluation and save ckpt."""
