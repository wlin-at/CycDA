...
pseudo_gt_dict = '/media/data_8T/UCF-HMDB/ablation_incepi3d/img2vid/bu_hmdb_to_ucf/bu12_to_ucf/step1_grl_tsn_img_model_64d/100perclass/100_no_source_vid/v1/20220209_214208_frame_ps.npy'
...
DA_config = dict(
    ...
    ps_filter_by='frame_v2',
    pseudo_gt_dict=
    '/media/data_8T/UCF-HMDB/ablation_incepi3d/img2vid/bu_hmdb_to_ucf/bu12_to_ucf/step1_grl_tsn_img_model_64d/100perclass/100_no_source_vid/v1/20220209_214208_frame_ps.npy',
    ps_thresh=0.7,
    ...
    exp_DA_name='DA',
    source_train_list=
    '/media/data_8T/UCF-HMDB/BU_HMDB_2_UCF/list_hmdb_train_vid_percent0.05.txt',
    target_train_list=
    '/media/data_8T/UCF-HMDB/datalist_new/list_ucf101_train_hmdb_ucf-feature.txt',
    val_list=
    '/media/data_8T/UCF-HMDB/datalist_new/list_ucf101_val_hmdb_ucf-feature.txt',
    test_list=
    '/media/data_8T/UCF-HMDB/datalist_new/list_ucf101_val_hmdb_ucf-feature.txt'
)
...
work_dir = './work_dirs/InceptionI3d_bu_hmdb_2u_DA_clip1x64_w_ps_img0.7_strid1_testclip3'
data = dict(
    videos_per_gpu=2,
    workers_per_gpu=0,
