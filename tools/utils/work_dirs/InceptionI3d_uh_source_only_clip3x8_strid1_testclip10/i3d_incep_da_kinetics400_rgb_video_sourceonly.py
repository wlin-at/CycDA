...
beta_high = 0.1
log_str = 'clip3x8_strid1_testclip10'
...
work_dir = './work_dirs/InceptionI3d_uh_source_only_clip3x8_strid1_testclip10'
data = dict(
    videos_per_gpu=2,
    workers_per_gpu=0,
    ...
    source_train=dict(
        ...
        pipeline=[
            dict(type='DecordInit'),
            dict(
                type='SampleFrames', clip_len=8, frame_interval=1,
                num_clips=3),
            dict(type='DecordDecode'),
            dict(type='Resize', scale=(-1, 256)),
            dict(
