...
beta_high = 0.1
log_str = 'clip1x64_strid1_testclip1'
...
DA_config = dict(
    ...
    source_train_list=
    '/media/data_8T/UCF-HMDB/UCF-HMDB_all/splits/list_ucf_all_train_split1.txt',
    target_train_list=
    '/media/data_8T/UCF-HMDB/UCF-HMDB_all/splits/list_ucf_all_train_split1.txt',
    val_list=
    '/media/data_8T/UCF-HMDB/UCF-HMDB_all/splits/list_ucf_all_val_split1.txt',
    test_list=
    '/media/data_8T/UCF-HMDB/UCF-HMDB_all/splits/list_ucf_all_val_split1.txt')
...
work_dir = './work_dirs/InceptionI3d_2ucf_all_target_only_clip1x64_strid1_testclip1'
data = dict(
    videos_per_gpu=1,
    workers_per_gpu=0,
